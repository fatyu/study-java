...
class FontFrame extends JFrame {
	public FontFrame() {
		...
		this.setSize(tk.getScreenSize().width / 3, tk.getScreenSize().height / 4);
...
class FontComponent extends JComponent {
	...
	public void paintComponent(Graphics g) {
		...
		//画字
		Font f = new Font(Font.DIALOG_INPUT, Font.PLAIN, 16).deriveFont(20f).deriveFont(14);
		g2d.setFont(f);
		...
		//画矩形框
		g2d.drawRect((int) x, (int) y, (int) r2d.getWidth(), (int) r2d.getHeight());
