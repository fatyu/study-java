...
public class BakFile extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		this.chooseFile.addActionListener(e -> chooseFile_actionPerformed(e));
		getContentPane().add(this.chooseFile, null);// 将按钮添加到pane�?
	}
	...
	private int copy(String filePath) {
		...
		if (file.isFile()) {
			...
			try {
				...
				fos.flush();// 将输入流的数据进行刷新并强制写出�?有的数据
